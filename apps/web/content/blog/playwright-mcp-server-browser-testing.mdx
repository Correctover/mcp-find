...
Microsoft's Playwright MCP server connects AI agents to a real browser using the accessibility tree, not screenshots or vision models. That difference matters: the accessibility tree gives the AI structured data about every interactive element on the page, so clicks, form fills, and navigation are reliable without inference. You get 25+ tools covering navigation, interaction, inspection, and tab management. Any MCP-compatible client works, including Claude Desktop, Cursor, Windsurf, and GitHub Copilot. This guide covers the mechanism, installation, a full tool reference, and where Playwright MCP outperforms browser-use, Puppeteer-based MCPs, and direct Playwright test scripts.

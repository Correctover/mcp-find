...
Explore the full [MCPFind automation category](/categories/automation) to compare Figma MCP alongside other integration servers for your workflow. For background on how MCP connects AI tools to external data sources, see our guide on [what is MCP](/blog/what-is-mcp). Teams using CI/CD automation alongside design workflows may also find value in [Best MCP Servers for DevOps and CI/CD](/blog/best-mcp-servers-devops-cicd). For the devtools servers that complement design-to-code pipelines on the code side, see [the best devtools MCP servers for repo intelligence](/blog/best-devtools-mcp-servers-repo-intelligence).
